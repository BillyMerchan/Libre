const MapDiagram = ({ onClick }) => {
  ...
  return (
    ...
    >
      <path
        id="337B" {...roomStyles.studyRoom} onClick={() => onClick('337B', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M428.916 22.103h-17.291v18.484H421.8l.054 7.562 7.061-.029z"
      />
      <path
        id="337A" {...roomStyles.studyRoom} onClick={() => onClick('337A', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M411.593 41.294v17.022h9.45v-17.022h-9.45"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="337E" {...roomStyles.studyRoom} onClick={() => onClick('337E', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M457.311 41.273v16.783h9.492v-16.783h-9.492"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="337D" {...roomStyles.studyRoom} onClick={() => onClick('337D', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M449.504 22.07h17.29V40.61H456.62l-.055 7.585-7.06-.029z"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="342A" {...roomStyles.studyRoom} onClick={() => onClick('342A', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M505.723 120.403v17.504h10.442v-17.504h-10.442"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="342B" {...roomStyles.studyRoom} onClick={() => onClick('342B', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M499.268 138.553v19.212h16.82v-19.212h-16.82"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="342C" {...roomStyles.studyRoom} onClick={() => onClick('342C', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M505.76 158.335v17.087h10.405v-17.087h-10.405"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="352A" {...roomStyles.studyRoom} onClick={() => onClick('352A', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M457.397 297.54v16.86h9.29v-16.86h-9.29"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="352E" {...roomStyles.studyRoom} onClick={() => onClick('352E', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M411.54 297.485v16.861h9.45v-16.861h-9.45"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="353A" {...roomStyles.studyRoom} onClick={() => onClick('353A', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M380.234 306.936v26.795h27.385v-26.795h-27.385"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="353B" {...roomStyles.studyRoom} onClick={() => onClick('353B', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M352.203 296.626v36.837h27.118v-36.837h-27.118"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="323A" {...roomStyles.studyRoom} onClick={() => onClick('323A', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M65.612 158.26v17.58h10.442v-17.58h-10.442"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="323B" {...roomStyles.studyRoom} onClick={() => onClick('323B', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M65.645 138.513v19.117h16.888v-19.117h-16.888"
      />
      <path
        id="323C" {...roomStyles.studyRoom} onClick={() => onClick('323C', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M65.65 120.289h10.48v17.542H65.65Z"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="332E" {...roomStyles.studyRoom} onClick={() => onClick('332E', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M160.664 41.32h9.585v16.888h-9.585z"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="332A" {...roomStyles.studyRoom} onClick={() => onClick('room1', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M114.887 41.294h9.61v16.86h-9.61z"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="332D" {...roomStyles.studyRoom} onClick={() => onClick('332D', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M170.144 22.096h-17.259l-.064 26.154 7.108-.01.016-7.602h10.2z"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="332C" {...roomStyles.studyRoom} onClick={() => onClick('332C', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
        d="M133.117 22.1h18.92l-.043 26.15-18.931.015z"
        description="Desk space: 1 person\n Windows: none \nWhite Board: none"
      />
      <path
        id="332B" {...roomStyles.studyRoom} onClick={() => onClick('332B', roomStyles.studyRoom.fill, roomDescriptions.studyRoom)}
      ...
      />
      <path
        id="Men's restroom" {...roomStyles.restroom} onClick={() => onClick("Men's bathroom", roomStyles.restroom.fill, roomDescriptions.studyRoom)}
